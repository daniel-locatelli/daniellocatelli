...
![Drei Spalten: links KI-Clients wie Chat-Oberflächen, IDEs und Agenten, in der Mitte der vorgeschlagene DOKwood-MCP-Server mit seinen Tools, Ressourcen, Prompts und der Auth-Brücke, rechts die DOKwood-Plattform mit Projekten und Aufbauten, Schichten und Produkten, Berechnungen und dem Datenwörterbuch, verbunden durch MCP- und GraphQL-Pfeile.](/assets/content/projects/dokwood/dokwood-mcp.svg)
