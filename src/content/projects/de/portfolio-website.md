...
- einen [Agent-Skills](https://agentskills.io/specification)-Index unter `/.well-known/agent-skills/` mit zwei `SKILL.md`-Dateien, die einem Agenten erklären, wie er die Website per MCP abfragt oder als Markdown liest.
