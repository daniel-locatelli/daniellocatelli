...
- um índice de [Agent Skills](https://agentskills.io/specification) em `/.well-known/agent-skills/` com dois arquivos `SKILL.md` que ensinam um agente a consultar o site via MCP ou a lê-lo como markdown.
