...
![Três colunas: clientes de IA como interfaces de chat, IDEs e agentes à esquerda, o servidor MCP do DOKwood proposto no centro com suas ferramentas, recursos, prompts e ponte de autenticação, e a plataforma DOKwood com produtos, composições, projetos, cálculos e o dicionário de dados à direita, ligados por setas MCP e GraphQL.](/assets/content/projects/dokwood/dokwood-mcp.svg)
