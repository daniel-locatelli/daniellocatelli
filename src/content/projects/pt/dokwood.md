...
![A designação DIN EN ISO 19650-1 dividida em suas partes: DIN para o órgão nacional, EN para a norma europeia, ISO para a norma internacional e o número e a parte; abaixo, os órgãos cobertos pela revisão.](../../../assets/content/research/timber-construction-standards/timber-construction-standards-cover.svg)
...
![Três colunas: clientes de IA como interfaces de chat, IDEs e agentes à esquerda, o servidor MCP do DOKwood proposto no centro com suas ferramentas, recursos, prompts e ponte de autenticação, e a plataforma DOKwood com projetos e composições, camadas e produtos, cálculos e o dicionário de dados à direita, ligados por setas MCP e GraphQL.](/assets/content/projects/dokwood/dokwood-mcp.svg)
