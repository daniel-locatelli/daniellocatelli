...
OtherLinks:
  - Text: livMatS Pavilion at ArchDaily
...
Diferentemente dos compósitos de fibra de carbono, que possuem décadas de dados de engenharia, os compósitos de fibra natural são muito menos previsíveis. As propriedades mecânicas variam dependendo da origem da fibra, do teor de umidade e dos padrões de enrolamento. Na época, não havia um método confiável para simular computacionalmente o comportamento estrutural desses elementos enrolados com fibra natural. A única forma de validar o projeto era por meio de testes de carga físicos em escala real.
