...
Embora a tarefa principal fosse a migração, também foi uma oportunidade de melhorar o conteúdo ao longo do caminho. Revisei e refinei títulos de páginas, meta descrições e estruturas de URL seguindo as melhores práticas de SEO. Para um instituto que produz pesquisa de classe mundial — do Pavilhão de Fibra BUGA aos Pavilhões de Pesquisa ICD/ITKE — ter conteúdo web bem estruturado e facilmente encontrável é fundamental.
...
Foi uma maneira incomum de aprender um idioma, mas notavelmente eficaz. Ao final do projeto, eu havia construído um vocabulário funcional sobre arquitetura, engenharia e administração universitária em alemão — conhecimento que se mostrou útil ao longo de todo o meu tempo na Alemanha.

## Aprendizados

Este projeto pode parecer modesto comparado à fabricação robótica ou à geração de formas computacionais, mas me ensinou algo valioso: a importância de como a pesquisa é comunicada. O pavilhão mais inovador ou o método de fabricação mais revolucionário significa pouco se não puder ser encontrado, compreendido e referenciado por outros. Um bom gerenciamento de conteúdo é a infraestrutura que torna o conhecimento acessível.

Foi também minha primeira experiência profissional trabalhando com um CMS — uma habilidade que mais tarde se mostraria fundamental quando construí o site da BuildSystems com Astro e a API do Notion, e eventualmente este próprio site de portfólio.
