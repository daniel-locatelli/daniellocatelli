...
![Three columns: AI clients such as chat interfaces, IDEs and agents on the left, the proposed DOKwood MCP server in the centre with its tools, resources, prompts and auth bridge, and the DOKwood platform with projects and buildups, layers and products, calculations and the data dictionary on the right, connected by MCP and GraphQL arrows.](/assets/content/projects/dokwood/dokwood-mcp.svg)
