...
- an [Agent Skills](https://agentskills.io/specification) index under `/.well-known/agent-skills/` with two `SKILL.md` files that teach an agent how to query the site via MCP or read it as markdown.
