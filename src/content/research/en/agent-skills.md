...
![SKILL.md tiles in three boxes (my own, grouped into AEC, web and personal; Matt Pocock's; community) feeding a single coding agent.](/assets/content/research/agent-skills/agent-skills-diagram.svg)
