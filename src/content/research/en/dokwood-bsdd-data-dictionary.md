...
![Left: Wall, Roof and Slab are kinds of Buildup, a System Data Template composed of layers and products, each product a Product Data Template. Right: a data template lists properties, a requirement template and then a requirement sheet tighten them to required values, and a data sheet satisfies them with declared values.](/assets/content/research/dokwood-bsdd-data-dictionary/data-templates.svg)
