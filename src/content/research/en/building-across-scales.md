...
![Figure 02 - Labour productivity in Japanese industry according to Construction Industry Handbook, 2012 (Bock, 2015).](../../../assets/content/research/building-across-scales/labour-productivity-in-japanese-industry-according-to-construction-industry.jpg)

![Figure 03 - Foster’s (1986) S-curves applied to future development of construction industry and technology. Drawing by B. Georgescu, Chair of Building Realization and Robotics (Bock, 2015).](../../../assets/content/research/building-across-scales/foster-s-1986-s-curves-applied-to-future-development-of-construction-industry.jpg)
...
![Figure 04 - Prefabrication of timber housing (FingerHaus, 2021).](../../../assets/content/research/building-across-scales/prefabrication-of-timber-housing-fingerhaus-2021.jpg)

![Figure 05 - View from the outside of the on-site factory (SMART) of the company Shimizu (Bock, 2015).](../../../assets/content/research/building-across-scales/view-from-the-outside-of-the-on-site-factory-smart-of-the-company-shimizu-bock.jpg)
...
![Figure 06 - Flexible and transportable robotic timber construction platform (TIM), consisting of a pick-and-place robot, central turntable and a glue-nail-mill (GNM) robot (Wagner et al, 2020).](../../../assets/content/research/building-across-scales/flexible-and-transportable-robotic-timber-construction-platform-tim-consisting.png)

![Figure 07 - Joint Effort: Robot team enabled carbon fibre joining strategies for lightweight wood construction (S. Lut, T. Stark, L.Siriwardena, 2020).](../../../assets/content/research/building-across-scales/joint-effort-robot-team-enabled-carbon-fibre-joining-strategies-for-lightweight.jpg)
...
![Figure 08 - The Sequential Roof: Automated prefabrication process (Gramazio Kohler Research, ETH Zurich, 2014).](../../../assets/content/research/building-across-scales/the-sequential-roof-automated-prefabrication-process-gramazio-kohler-research.jpg)

![Figure 09 - The Sequential Roof: Manual on-site assembly process (Gramazio Kohler Research, ETH Zurich, 2014).](../../../assets/content/research/building-across-scales/the-sequential-roof-manual-on-site-assembly-process-gramazio-kohler-research.jpg)
...
![Figure 10 - Image from the marketing campaign for the Holzbau Offensive Baden-Württemberg, Ministerium für Ernährung, Ländlichen Raum und Verbraucherschutz (MLR).](../../../assets/content/research/building-across-scales/image-from-the-marketing-campaign-for-the-holzbau-offensive-baden-wurttemberg.jpg)


![Figure 11 - Current wood construction system typologies (Kaufmann, 2018).](../../../assets/content/research/building-across-scales/figure-11-prefabrication-combined.png)
...
![Figure 12 - Efficiency of connections between 100mm by 200mm timber members transmitting a tensile axial force (Ramage, 2017).](../../../assets/content/research/building-across-scales/efficiency-of-connections-between-100mm-by-200mm-timber-members-transmitting-a.png)
...
![Figure 17 - Chicago Horizon (Ultramoderne, 2015).](../../../assets/content/research/building-across-scales/chicago-horizon-ultramoderne-2015.jpg)
...
![Figure 23g](../../../assets/content/research/building-across-scales/g.png)
...
![Figure 24 - Schematic of current state-of-the-art.](../../../assets/content/research/building-across-scales/schematic-of-current-state-of-the-art.jpg)
...
![Figure 38 - Panel approaching.](../../../assets/content/research/building-across-scales/panel-approaching.jpg)
...
![Figure 41 - Mobile robotic platform setup (TIM).](../../../assets/content/research/building-across-scales/mobile-robotic-platform-setup-tim.png)

![Figure 42 - Robot A placing the panels from the magazine onto the working station of the platform.](../../../assets/content/research/building-across-scales/robot-a-placing-the-panels-from-the-magazine-onto-the-working-station-of-the.png)

![Figure 43 - Afterwards, robot B will proceed with applying the glue onto the panel.](../../../assets/content/research/building-across-scales/afterwards-robot-b-will-proceed-with-applying-the-glue-onto-the-panel.jpg)

![Figure 44 - The next task involves flipping the panel. Here both robots work together to accomplish this task.](../../../assets/content/research/building-across-scales/the-next-task-involves-flipping-the-panel-here-both-robots-work-together-to.jpg)

![Figure 45 - After the panel is flipped, robot B would continue placing the devices into the pre-drilled holes. Additionally, the dowels for the passive alignment would be placed.](../../../assets/content/research/building-across-scales/after-the-panel-is-flipped-robot-b-would-continue-placing-the-devices-into-the.jpg)

![Figure 46 - Afterwards, a crane would lift the element up and position it on top of the structure while the cameras guide the crane operation.](../../../assets/content/research/building-across-scales/afterwards-a-crane-would-lift-the-element-up-and-position-it-on-top-of-the.jpg)

![Figure 47 - The before-placed dowels and the engraved channels will help align the last centimeters to passively slide the panels into their correct position.](../../../assets/content/research/building-across-scales/the-before-placed-dowels-and-the-engraved-channels-will-help-align-the-last.jpg)

![Figure 48 - In the next step, the robotic device would proceed with applying the needed pressure for the glue in situ.](../../../assets/content/research/building-across-scales/in-the-next-step-the-robotic-device-would-proceed-with-applying-the-needed.jpg)

![Figure 49 - And after a certain amount of time, after the glue is dried, the device will be able to relieve its pressure from the hole, allowing it to fall to the ground to be re-feed back into the system.](../../../assets/content/research/building-across-scales/device-falling-from-hole.jpg)
...
![Figure 50 - Robotic clamping device.](../../../assets/content/research/building-across-scales/robotic-clamping-device.jpg)
...
![Figure 53 - Pressurized area of influence.](../../../assets/content/research/building-across-scales/pressurized-area-of-influence.jpg)
...
![Figure 63  - Prefabrication of the demonstrator pieces.](../../../assets/content/research/building-across-scales/prefabrication-of-the-demonstrator-pieces.jpg)

![Figure 64  - Preparation for transport of the prefabricated timber panels.](../../../assets/content/research/building-across-scales/preparation-for-transport-of-the-prefabricated-timber-panels.jpg)
...
![Figure 65 - Demonstrated construction site setup: mobile robotic platform (TIM), spider crane and the custom device.](../../../assets/content/research/building-across-scales/demonstrated-construction-site-setup-mobile-robotic-platform-tim-spider-crane.jpg)
...
![Figure 75  - Final demonstrator.](../../../assets/content/research/building-across-scales/final-demonstrator.jpg)
### Discussion
...
## Appendix
![Three images of the clamping robot: closed; exploded parts and transparent cover; transparent cover.](../../../assets/content/research/building-across-scales/three-images-of-the-clamping-robot-closed-exploded-parts-and-transparent-cover.jpg)
![Photo of the clamping robot in action.](../../../assets/content/research/building-across-scales/the-clamping-robot-in-action-01.jpg)
![Photo of the pressure robots on the demonstrator.
Clamping robots on the demonstrator.](../../../assets/content/research/building-across-scales/the-pressure-robots-on-the-demonstrator-clamping-robots-on-the-demonstrator-01.jpg)
![Close-up photo of the demonstrator ceiling.
Close-up of the demonstrator ceiling.](../../../assets/content/research/building-across-scales/close-up-photo-of-the-demonstrator-ceiling-close-up-of-the-demonstrator-ceiling-01.jpg)
![Photo of the spider crane just after positioning the last plate of the demonstrator.](../../../assets/content/research/building-across-scales/the-spider-crane-just-after-positioning-the-last-plate-of-the-demonstrator-01.jpg)
![Photo of the demonstrator finished with the industrial robotic arms (Kukas) in the background.](../../../assets/content/research/building-across-scales/the-demonstrator-finished-with-the-industrial-robotic-arms-kukas-in-the.jpg)
![Photo of the demonstrator finished with the spider crane in the background.](../../../assets/content/research/building-across-scales/the-demonstrator-finished-with-the-spider-crane-in-the-background-01.jpg)
![Photo of the demonstrator at night: the holes for the clamping robots are now used for light fixtures.](../../../assets/content/research/building-across-scales/the-demonstrator-at-night-the-holes-for-the-clamping-robots-are-now-used-for.jpg)
