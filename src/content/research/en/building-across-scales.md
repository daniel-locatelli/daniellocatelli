...
**Check the article published on Automation in Construction:**
...
![Figure 02 - Labour productivity in Japanese industry according to Construction Industry Handbook, 2012 (Bock, 2015).
...
![Figure 03 - Foster’s (1986) S-curves applied to future development of construction industry and technology. Drawing by B. Georgescu, Chair of Building Realization and Robotics (Bock, 2015).
...
![Figure 04 - Prefabrication of timber housing (FingerHaus, 2021).
...
![Figure 05 - View from the outside of the on-site factory (SMART) of the company Shimizu (Bock, 2015).
...
![Figure 06 - Flexible and transportable robotic timber construction platform (TIM), consisting of a pick-and-place robot, central turntable and a glue-nail-mill (GNM) robot (Wagner et al, 2020).
...
![Figure 07 - Joint Effort: Robot team enabled carbon fibre joining strategies for lightweight wood construction (S. Lut, T. Stark, L.Siriwardena, 2020).
...
![Figure 08 - The Sequential Roof: Automated prefabrication process (Gramazio Kohler Research, ETH Zurich, 2014).
...
![Figure 09 - The Sequential Roof: Manual on-site assembly process (Gramazio Kohler Research, ETH Zurich, 2014).
...
![Figure 10 - Image from the marketing campaign for the Holzbau Offensive Baden-Württemberg, Ministerium für Ernährung, Ländlichen Raum und Verbraucherschutz (MLR).
...
![Figure 12 - Efficiency of connections between 100mm by 200mm timber members transmitting a tensile axial force (Ramage, 2017).
...
![Figure 13 - Material-robotic system overview.
...
![Figure 15 - TS3 Glue being applied (TS3).
...
![Figure 14 - Schematic drawings showing butt to butt connections examples in which the TS3 glue could be applied (TS3).
...
![Figure 17 - Chicago Horizon (Ultramoderne, 2015).
...
![Figure 18 - Exploded Axonometric of Chicago Horizon (Schneider et al. 2017).
...
![Figure 19 - Mass Timber Fastening (Swinerton’s Innovation, 2021).
...
![Figure 20 - Automatic Assembly of Jointed Timber Structure Using Distributed Robotic Clamps (Leung et al.,ETH Zurich, 2021).
...
![Figure 21  - Material system connectivity diagram.
...
![Figure 22 - Robotic system connectivity diagram.
...
![Figure 24 - Schematic of current state-of-the-art.
...
![Figure 30 - Heterogeneous Robotic System.
...
![Figure 31 - Material-robotic system diagram.
...
![Figure 35 - Finite element analysis from the paneling.
...
![Figure 36  - Glue distribution: darker areas need more glue.
...
![Figure 37 - Points to place the holes for the robotic clamps.
...
![Figure 39 - Panel hitting the channels.
...
![Figure 41 - Mobile robotic platform setup (TIM).
...
![Figure 42 - Robot A placing the panels from the magazine onto the working station of the platform.
...
![Figure 43 - Afterwards, robot B will proceed with applying the glue onto the panel.
...
![Figure 44 - The next task involves flipping the panel. Here both robots work together to accomplish this task.
...
![Figure 45 - After the panel is flipped, robot B would continue placing the devices into the pre-drilled holes. Additionally, the dowels for the passive alignment would be placed.
...
![Figure 46 - Afterwards, a crane would lift the element up and position it on top of the structure while the cameras guide the crane operation.
...
![Figure 47 - The before-placed dowels and the engraved channels will help align the last centimeters to passively slide the panels into their correct position.
...
![Figure 48 - In the next step, the robotic device would proceed with applying the needed pressure for the glue in situ.
...
![Figure 50 - Robotic clamping device.
...
![Figure 53 - Pressurized area of influence.
...
![Figure 58 - Estimative of force necessary to glue 200mm thick spruce.
...
![Figure 57 - Parameters affecting the area of influence.
...
![Figure 60 - Custom crane end-effector hook.
...
![Figure 63  - Prefabrication of the demonstrator pieces.
...
![Figure 64  - Preparation for transport of the prefabricated timber panels.
...
![Figure 65 - Demonstrated construction site setup: mobile robotic platform (TIM), spider crane and the custom device.
...
Clamping robot: closed; exploded parts and transparent cover; transparent cover.](/assets/content/research/building-across-scales/block-175f1667-7e3f-4450-9b11-48e6d3016a74.jpg)
![Photo of the clamping robot in action.
Clamping robot in action.](/assets/content/research/building-across-scales/block-f966ac49-acb4-408b-b6d1-bfab9f6b17bc.jpg)
...
Spider crane just after positioning the last plate of the demonstrator.](/assets/content/research/building-across-scales/block-e1aa4cce-c719-4d79-a2cf-d53684a93c4b.jpg)
...
Demonstrator at night: the holes for the clamping robots are now used for light fixtures.](/assets/content/research/building-across-scales/block-22f2449b-2480-4467-ba79-0233a502a54b.jpg)
