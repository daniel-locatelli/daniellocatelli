...
![Figura 02 - Produtividade do trabalho na indústria japonesa de acordo com Construction Industry Handbook, 2012 (Bock, 2015).
...
![Figura 03 - Curvas em S de Foster (1986) aplicadas ao desenvolvimento futuro da indústria e tecnologia da construção. Desenho por B. Georgescu, Cátedra de Realização de Edifícios e Robótica (Bock, 2015).
...
![Figura 04 - Pré-fabricação de habitação em madeira (FingerHaus, 2021).
...
![Figura 05 - Vista externa da fábrica no canteiro (SMART) da empresa Shimizu (Bock, 2015).
...
![Figura 06 - Plataforma robótica transportável e flexível para construção em madeira (TIM), consistindo em um robô pick-and-place, mesa giratória central e um robô de colagem-pregação-fresagem (GNM) (Wagner et al, 2020).
...
![Figura 07 - Esforço Conjunto (Joint Effort): Equipe de robôs viabilizou estratégias de união de fibra de carbono para construção leve em madeira (S. Lut, T. Stark, L. Siriwardena, 2020).
...
![Figura 08 - The Sequential Roof: Processo de pré-fabricação automatizado (Gramazio Kohler Research, ETH Zurich, 2014).
...
![Figura 09 - The Sequential Roof: Processo de montagem manual no canteiro (Gramazio Kohler Research, ETH Zurich, 2014).
...
![Figura 10 - Imagem da campanha de marketing para a Holzbau Offensive Baden-Württemberg, Ministerium für Ernährung, Ländlichen Raum und Verbraucherschutz (MLR).
...
![Figura 12 - Eficiência de conexões entre membros de madeira de 100mm por 200mm transmitindo uma força axial de tração (Ramage, 2017).
...
![Figura 13 - Visão geral do sistema material-robótico.
...
![Figura 15 - Aplicação da cola TS3 (TS3).
...
![Figura 14 - Desenhos esquemáticos mostrando exemplos de conexões de topo (butt to butt) nas quais a cola TS3 poderia ser aplicada (TS3).
...
![Figura 17 - Chicago Horizon (Ultramoderne, 2015).
...
![Figura 18 - Axonometria explodida do Chicago Horizon (Schneider et al. 2017).
...
![Figura 19 - Fixação de Madeira Engenheirada (Swinerton’s Innovation, 2021).
...
![Figura 20 - Montagem automática de estrutura de madeira articulada usando grampos robóticos distribuídos (Leung et al., ETH Zurich, 2021).
...
![Figura 21 - Diagrama de conectividade do sistema material.
...
![Figura 22 - Diagrama de conectividade do sistema robótico.
...
![Figura 24 - Esquema do estado da arte atual.
...
![Figura 25 - Proposta da pesquisa.
...
![Figura 30 - Sistema Robótico Heterogêneo.
...
![Figura 31 - Diagrama do sistema material-robótico.
...
![Figura 32 - Sobreposição da paginação.
...
![Figura 35 - Análise de elementos finitos da paginação.
...
![Figura 36 - Distribuição de cola: áreas mais escuras necessitam de mais cola.
...
![Figura 37 - Pontos para posicionar os furos para os grampos robóticos.
...
![Figura 38 - Aproximação do painel.
...
![Figura 39 - Painel atingindo os canais.
...
![Figura 41 - Configuração da plataforma robótica móvel (TIM).
...
![Figura 42 - Robô A posicionando os painéis do magazine para a estação de trabalho da plataforma.
...
![Figura 43 - Em seguida, o Robô B prossegue com a aplicação da cola no painel.
...
![Figura 44 - A próxima tarefa envolve virar o painel. Aqui, ambos os robôs trabalham juntos para realizar esta tarefa.
...
![Figura 45 - Após o painel ser virado, o Robô B continuaria a posicionar os dispositivos nos furos pré-perfurados. Adicionalmente, os pinos para o alinhamento passivo seriam colocados.
...
![Figura 46 - Depois disso, um guindaste elevaria o elemento e o posicionaria no topo da estrutura, enquanto câmeras guiam a operação do guindaste.
...
![Figura 47 - Os pinos previamente colocados e os canais gravados ajudarão a alinhar os últimos centímetros para deslizar passivamente os painéis em sua posição correta.
...
![Figura 48 - Na etapa seguinte, o dispositivo robótico procederia com a aplicação da pressão necessária para a cola in situ.
...
![Figura 49 - E após um determinado período de tempo, uma vez que a cola esteja seca, o dispositivo será capaz de aliviar sua pressão no furo, permitindo que caia no chão para ser realimentado no sistema.
...
![Figura 50 - Dispositivo de fixação robótica.
...
![Figura 53 - Área de influência pressurizada.
...
![Figura 56 - Gráfico do teste de resistência.
...
![Figura 57 - Configuração do teste de resistência.
...
![Figura 58 - Estimativa da força necessária para colagem de abeto de 200 mm de espessura.
...
![Figura 57 - Parâmetros que afetam a área de influência.
...
![Figura 60 - Gancho efetuador final customizado para o guindaste.
...
![Figura 63 - Pré-fabricação das peças do demonstrador.
...
![Figura 64 - Preparação para o transporte dos painéis de madeira pré-fabricados.
...
![Figura 65 - Configuração do canteiro de obras demonstrado: plataforma robótica móvel (TIM), guindaste aranha e o dispositivo customizado.
...
# **Apêndice**
![Three images of the clamping robot: closed; exploded parts and transparent cover; transparent cover.
Clamping robot: closed; exploded parts and transparent cover; transparent cover.](../../../assets/content/research/building-across-scales/block-2dcbf53b-9ce3-81e0-b619-c22677338fcb.jpg)

![Photo of the clamping robot in action.
Clamping robot in action.](../../../assets/content/research/building-across-scales/block-2dcbf53b-9ce3-81e2-be25-fe6d868e04bf.jpg)
...
![Photo of the spider crane just after positioning the last plate of the demonstrator.
Spider crane just after positioning the last plate of the demonstrator.](../../../assets/content/research/building-across-scales/block-2dcbf53b-9ce3-81c1-8490-cbdd8ea27445.jpg)
...
![Photo of the demonstrator at night: the holes for the clamping robots are now used for light fixtures.
Demonstrator at night: the holes for the clamping robots are now used for light fixtures.](../../../assets/content/research/building-across-scales/block-2dcbf53b-9ce3-81f3-a08f-ed90b342bc0e.jpg)
