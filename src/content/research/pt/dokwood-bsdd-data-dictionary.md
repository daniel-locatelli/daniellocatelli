...
![À esquerda: Wall, Roof e Slab são tipos de Buildup, um System Data Template composto de camadas e produtos, cada produto um Product Data Template. À direita: um modelo de dados lista propriedades, um modelo de requisitos e depois uma folha de requisitos os restringem a valores exigidos e uma folha de dados os satisfaz com valores declarados.](/assets/content/research/dokwood-bsdd-data-dictionary/data-templates.svg)
