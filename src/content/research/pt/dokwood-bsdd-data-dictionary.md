...
Modelar um conjunto inteiro como modelo de dados ainda é raro; a maioria dos dicionários para em produtos isolados. Codificar a composição é onde o DOKwood vai um passo além, e é o que permite a segunda metade da imagem. O dicionário público oferece as propriedades e classes. Cada empresa de madeira compõe a partir delas os seus próprios modelos de dados (uma parede externa da Schärholzbau). Uma folha de requisitos então restringe um modelo a valores exigidos, seja para toda a empresa (Rw de pelo menos 56 dB) ou para um projeto (REI 90 também), e uma folha de dados diz o que foi declarado ou medido. A própria ISO 23387 conhece apenas o modelo de dados e a folha de dados, e permite que uma folha de dados represente tanto um requisito quanto um produto; folha de requisitos é o nome que o DOKwood dá a esse primeiro tipo, mantido à parte porque é escrito por outras pessoas, em outro momento. Uma única regra de aninhamento amarra a cadeia: o genérico contém o requisito, que contém o valor. A folha de dados preenchida de uma composição fabricada é precisamente o que um passaporte digital de produto carrega.
