...
![Drei Spalten mit SKILL.md-Kacheln (meine eigenen, gruppiert in AEC, Web und Persönlich; Matt Pococks; Community) speisen einen einzigen Coding-Agenten.](/assets/content/research/agent-skills/agent-skills-diagram.svg)
...
Daneben stehen zwei private Referenz-Skills: einer für BTLx, das Austauschformat für Holz-CNC, und einer für compas_ifc, damit der Agent die Spezifikation prüft, bevor er eine Parameter- oder Versionsfrage beantwortet.
