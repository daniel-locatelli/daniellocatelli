...
const platform = [
  ["Data", "projects, buildups, layers, products"],
  ["Rules", "requirements, calculations, certificates"],
  ["Vocabulary", "tenant dictionary, bSDD"],
];
const tw = colW - 64;
...
const svg = svgDoc({
  ...
  h: H,
  id: ID,
  title: "Three columns: AI clients (chat interfaces, IDEs and coding agents, automation) on the left, the proposed DOKwood MCP server in the centre with its tools, resources, prompts and auth bridge, and the DOKwood platform on the right with its data (projects, buildups, layers, products), rules (requirements, calculations, certificates) and vocabulary (tenant dictionary, bSDD); two-way arrows labelled MCP and GraphQL connect them",
  body: b,
});
