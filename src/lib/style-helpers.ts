...
export const getNotionColorToTailwindColor = (s: string) => {
  ...
  const colorMap = {
    ...
    "brown-background":
      "px-1 rounded bg-nbrown-bg-light dark:bg-nbrown-bg-dark",
    "orange-background":
      "px-1 rounded bg-norange-bg-light dark:bg-norange-bg-dark",
    "yellow-background":
      "px-1 rounded bg-nyellow-bg-light dark:bg-nyellow-bg-dark",
    "green-background":
      "px-1 rounded bg-ngreen-bg-light dark:bg-ngreen-bg-dark",
    "blue-background": "px-1 rounded bg-nblue-bg-light dark:bg-nblue-bg-dark",
    "purple-background":
      "px-1 rounded bg-npurple-bg-light dark:bg-npurple-bg-dark",
