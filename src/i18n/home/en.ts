...
export const t: I18nHome = {
  ...
  hero: {
    ...
    chat: {
      initialMessage:
        "Hi! Ask me anything related to my work, experience, or projects.\n\n*Please note: Responses are generated by AI (Anthropic Claude) and may contain inaccuracies. This chat does not constitute professional, legal, or technical advice. Please verify any information independently.*",
