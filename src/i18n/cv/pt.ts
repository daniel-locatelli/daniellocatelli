...
export const t: I18nCV = {
  ...
  summary:
    "Doutorando no Gramazio Kohler Research, ETH Zurique, pesquisando do design computacional à fabricação de sistemas construtivos em placas de madeira e como a IA pode apoiar o processo de projeto. Experiência como engenheiro de software e pesquisador de design computacional especializado em construção em madeira, integrando design e engenharia através de C#/.NET e Python. Mestre pelo ITECH (Universidade de Stuttgart) com foco em sistemas robóticos multiescalares para madeira engenheirada. Profissional trilíngue (inglês, alemão e português) dedicado a solucionar problemas estruturais complexos através de software escalável e fabricação orientada por dados.",
};
