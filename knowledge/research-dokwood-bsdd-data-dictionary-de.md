URL: https://daniellocatelli.com/de/research/dokwood-bsdd-data-dictionary

# DOKwood bSDD-Datenwörterbuch
...
Das Wörterbuch ist unter dem Organisationscode der Hochschule München als `hm/dokwood` veröffentlicht und durchlief im Projekt dreizehn Versionen, v0.1 bis v0.13. Der Inhalt wird in Excel mit der buildingSMART-Vorlage verfasst, mit dem buildingSMART-eigenen Konverter in das bSDD-JSON-Importmodell umgewandelt und hochgeladen. Ab v0.8 erzeugt ein kleines Python-Build-Skript jede Version, indem es die Arbeitsmappe der Vorgängerversion verändert; der Docstring des Skripts ist damit das verbindliche Änderungsprotokoll dieser Version, und jede Veröffentlichung ist aus der vorherigen reproduzierbar.
...
Die Form des Wörterbuchs folgt der ISO 23387, der Norm für Datenvorlagen von Bauobjekten, aufbauend auf ISO 12006-3 für das Wörterbuch-Rahmenwerk und ISO 23386 für kontrollierte Merkmale. Eine Datenvorlage listet auf, welche Merkmale eine Art von Objekt beschreiben, ohne Werte. DOKwood nutzt zwei: ein System Data Template für einen Aufbau, weil ein Aufbau ein System aus Schichten ist, und ein Product Data Template für ein Produkt. Ein Aufbau setzt sich aus Schichten zusammen und eine Schicht aus Produkten, kodiert als HasPart-Komposition der Norm. Ob eine Schicht eine eigene Vorlage braucht, um Dicke, Rolle oder Funktion zu tragen, ist eine offene Frage für die nächste Version.
