...
export default async function seed() {
  ...
  await db.insert(FreelanceWorks).values([
    ...
    },
    {
      id: 2,
      locale: "en",
      title: "Margarita House Refurbishment",
      date: "06.2017 → 08.2017",
      description: "House Refurbishment project",
      location: "São Paulo, Brazil",
    },
    {
      id: 3,
      ...
      description:
        "Marketing action. Rendering of installations, bars and clothing.",
      location: null,
    },
    {
      id: 4,
      locale: "en",
      title: "Le Sandwich: Restaurant Refurbishment",
      date: "06.2016",
      description:
        "Architect in charge of design, and construction supervision.",
      location: "São Paulo, Brazil",
    },
  ]);
  ...
  await db.insert(BuildSystemsWorks).values([
    {
      ...
      description:
        "Developed in Astro, leveraging Notion API to use Notion as a CMS.",
    },
    {
      id: 2,
      locale: "en",
      ...
      category: "Web development",
      type: "Online tool",
      description: "Web app developed in Angular and PostgreSQL.",
    },
    {
      id: 3,
      locale: "en",
      ...
      type: "Online tool",
      description:
        "Developed the interface for a tool to create building components.",
    },
    {
      id: 4,
      locale: "en",
    ...
    },
    {
      ...
      type: "Grasshopper tool",
      description:
        "Developed a plugin with the functionality of previous configurators.",
    },
    {
      id: 6,
      locale: "en",
    ...
    },
    {
      ...
      type: "Grasshopper tool",
      description:
        "Development of a configurator to create building envelopes.",
    },
    {
      id: 9,
      locale: "en",
  ...
  await db.insert(ArtEngineeringWorks).values([
    ...
    },
    {
      ...
      description: "Summer 2023: Technical and fabrication drawings.",
    },
    {
      id: 3,
      locale: "en",
  ...
  await db.insert(MarkoBraiovicWorks).values([
    {
      id: 1,
      locale: "en",
      title: "BlastU 2019",
